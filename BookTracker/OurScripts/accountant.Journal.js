...
$("#resetForm").click(function (e) {
    ...
    $("#attach").attr("disabled", "disabled");
    $("#saveOrder").attr("disabled", "disabled");
    $("#newJournalDropZone").attr("disabled", "disabled");    
    $("#comments").attr("disabled", "disabled");
